...
#HOST   
HTTPSERV1="https://raw.githubusercontent.com/remytr-org/repo/master/CCCAM.txt"                                       
...
cd /etc/tuxbox/config/oscam-emu
OUTPUT=/etc/tuxbox/config/oscam-emu/oscam.server
OUTPUT2=/etc/tuxbox/config/oscam-emu/oscam.server
SERVER=/tmp/oscam.options
SERVER=oscam.options
#function convert_servers 
OUTPUT="/etc/tuxbox/config/oscam-emu/oscam.server"
OUTPUT2=/etc/tuxbox/config/oscam-emu/oscam.server
HTTPSERV="https://raw.githubusercontent.com/remytr-org/repo/master/oscam.server"         
...
OUTPUT=/etc/tuxbox/config/ncam-emu/ncam.server
OUTPUT2=/etc/tuxbox/config/ncam-emu/ncam.server
